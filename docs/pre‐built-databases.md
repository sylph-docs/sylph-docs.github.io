...
Most of the databases have associated taxonomies that sylph can utilize. See [here for more information on taxonomy integration](sylph-tax.md).
...
2. [SMAG](https://www.nature.com/articles/s41467-023-43000-z) catalogue of 21,077 soil MAGs, `-c 200` (2.5 GB):
...
1. 595 representative RefSeq fungi genomes (downloaded 2024-07-25), `-c 200` 
2. 713 TARA Oceans eukaryotic MAGs/SAGs from [Delmont et al.](https://doi.org/10.1016/j.xgen.2022.100123), `-c 200` 
