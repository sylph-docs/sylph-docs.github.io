...
```sh
# profile something with pre-built GTDB_r226 / IMGVR_4.1 databases
sylph profile .... gtdb-r226-c200-dbv1.syldb imgvr_c200_v0.3.0.syldb  > sylph_results/my_result.tsv
```
...
sylph-tax taxprof sylph_results/*.tsv -t GTDB_r226 IMGVR_4.1 -o output_prefix-
